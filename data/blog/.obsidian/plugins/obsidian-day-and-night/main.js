  ...
  'node_modules/moment/moment.js'(exports, module2) {
    ;(function (global, factory) {
      ...
      function Duration(duration) {
        ...
        this._milliseconds =
          +milliseconds2 + seconds2 * 1e3 + minutes2 * 6e4 + hours2 * 1e3 * 60 * 60
...
var DayAndNight = class extends import_obsidian2.Plugin {
  ...
  updateTheme() {
    return __async(this, null, function* () {
      ...
      if (
        !this.settings.pauseThemeToggle &&
        (this.getCurrentTheme() != themeToApply ||
          this.getCurrentColorScheme() != colorSchemeToApply)
      ) {
  ...
  getThemeToApply() {
    const dayDate = (0, import_moment.default)(
      this.settings.dayTime,
      import_moment.default.HTML5_FMT.TIME
    ).toDate()
    const nightDate = (0, import_moment.default)(
    ...
    if (
      (0, import_moment.default)().isAfter(dayDate) &&
      (0, import_moment.default)().isBefore(nightDate)
    ) {
      themeToApply = this.settings.dayTheme
      colorSchemeToApply = this.settings.dayColorScheme
    } else if (
      (0, import_moment.default)().isSameOrAfter(nightDate) ||
      (0, import_moment.default)().isBefore(dayDate)
    ) {
  ...
  isCurrentThemeNightTheme() {
    ...
    return (
      currentTheme == this.settings.nightTheme &&
